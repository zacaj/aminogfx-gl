    ...
    if (ev.type == EV_KEY) {
        ...
        if (ev.code == BTN_LEFT) {
            ...
            switch (ev.code) {
                ...
                case KEY_PERIOD: keycode = 46 /* . */; break;
                case KEY_SLASH: keycode = 47 /* / */; break;
                case KEY_LEFT_BRACKET: keycode = 91 /* [ */; break;
                case KEY_BACKSLASH: keycode = 92 /* \ */; break;
                case KEY_RIGHT_BRACKET: keycode = 93 /* ] */; break;
                case KEY_GRAVE_ACCENT: keycode = 96 /* ` */; break;
                case KEY_WORLD_1: keycode = 161 /* non-US #1 */; break;
                case KEY_WORLD_2: keycode = 162 /* non-US #2 */; break;
                case KEY_ESCAPE: keycode = 256; break;
                ...
                case KEY_PAGE_UP: keycode = 266; break;
                case KEY_PAGE_DOWN: keycode = 267; break;
                case KEY_HOME: keycode = 268; break;
                case KEY_END: keycode = 269; break;
                case KEY_CAPS_LOCK: keycode = 280; break;
                case KEY_SCROLL_LOCK: keycode = 281; break;
                case KEY_NUM_LOCK: keycode = 282; break;
                case KEY_PRINT_SCREEN: keycode = 283; break;
                ...
                case KEY_F25: keycode = 314; break;
                case KEY_KP_0: keycode = 320; break;
                case KEY_KP_1: keycode = 321; break;
                case KEY_KP_2: keycode = 322; break;
                case KEY_KP_3: keycode = 323; break;
                case KEY_KP_4: keycode = 324; break;
                case KEY_KP_5: keycode = 325; break;
                case KEY_KP_6: keycode = 326; break;
                case KEY_KP_7: keycode = 327; break;
                case KEY_KP_8: keycode = 328; break;
                case KEY_KP_9: keycode = 329; break;
                case KEY_KP_DECIMAL: keycode = 330; break;
                case KEY_KP_DIVIDE: keycode = 331; break;
                case KEY_KP_MULTIPLY: keycode = 332; break;
                case KEY_KP_SUBTRACT: keycode = 333; break;
                case KEY_KP_ADD: keycode = 334; break;
                case KEY_KP_ENTER: keycode = 335; break;
                case KEY_KP_EQUAL: keycode = 336; break;
                case KEY_LEFT_SHIFT: keycode = 340; break;
                case KEY_LEFT_CONTROL: keycode = 341; break;
                case KEY_LEFT_ALT: keycode = 342; break;
                case KEY_LEFT_SUPER: keycode = 343; break;
                case KEY_RIGHT_SHIFT: keycode = 344; break;
                case KEY_RIGHT_CONTROL: keycode = 345; break;
                case KEY_RIGHT_ALT: keycode = 346; break;
                case KEY_RIGHT_SUPER: keycode = 347; break;
            }
